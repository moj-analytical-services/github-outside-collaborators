...
- Manual: This [GitHub Action](https://github.com/moj-analytical-services/github-outside-collaborators/actions/workflows/remove-collaborator.yml) will edit and create the pull request to remove a specific collaborator from a repository:
