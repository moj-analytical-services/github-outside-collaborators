class GithubCollaborators
  ...
  describe FullOrgMember do
    context "test FullOrgMember" do
      ...
      it "call add_everyone_team_repositories" do
        @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME1, TEST_REPO_NAME2])
        test_equal(@full_org_member.everyone_team_repositories.length, 2)
      end
      ...
      context "call add_terraform_repositories" do
        ...
        it "when don't add to array because repo is an archived everyone team repo" do
          @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME1])
          test_equal(@full_org_member.everyone_team_repositories.length, 1)
        ...
        it "when don't add to array because repo is an everyone team repo" do
          @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME1])
          test_equal(@full_org_member.everyone_team_repositories.length, 1)
          @full_org_member.add_terraform_repositories([TEST_REPO_NAME1])
          test_equal(@full_org_member.terraform_repositories.length, 0)
      ...
      context "call get_full_org_member_repositories" do
        ...
        it "when repo is already org repo" do
          @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME2])
          @full_org_member.get_full_org_member_repositories
          test_equal(@full_org_member.github_repositories.length, 2)
        end
      ...
      context "call odd_full_org_member_check" do
        ...
        it "when org team array greater than 0" do
          @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME])
          test_equal(@full_org_member.everyone_team_repositories.length, 1)
      ...
      context "call removed_from_github_repository" do
        ...
        it "when user is in a Terraform file but not on the GitHub repo but repo is an everyone team repo" do
          @full_org_member.add_terraform_repositories([TEST_REPO_NAME1])
          @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME1])
          test_equal(@full_org_member.terraform_repositories.length, 1)
          test_equal(@full_org_member.github_repositories.length, 0)
      ...
      context "" do
        ...
        context "call missing_from_terraform_files" do
          ...
          it "when github and terraform repositories do not match but a repo is an everyone team repo" do
            @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME1])
            @full_org_member.get_full_org_member_repositories
            @full_org_member.add_terraform_repositories([TEST_REPO_NAME1])
            test_equal(@full_org_member.github_repositories.length, 2)
          ...
          it "when github and terraform repositories do match but a repo is an everyone team repo" do
            @full_org_member.add_everyone_team_repositories([TEST_REPO_NAME1])
            @full_org_member.get_full_org_member_repositories
            @full_org_member.add_terraform_repositories([TEST_REPO_NAME2, TEST_REPO_NAME1, TEST_REPO_NAME3])
            test_equal(@full_org_member.github_repositories.length, 2)
