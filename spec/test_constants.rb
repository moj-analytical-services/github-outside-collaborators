...
module TestConstants
  ...
  TEST_URL = "#{GH_API_URL}/github-outside-collaborators/issues"
  HREF = "#{GH_ORG_URL}/github-outside-collaborators/blob/main/terraform/#{REPOSITORY_NAME}.tf|terraform file"
